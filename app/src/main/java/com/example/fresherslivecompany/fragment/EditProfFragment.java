 ...
 * Use the {@link EditProfFragment#newInstance} factory method to
...
public class EditProfFragment extends Fragment {
    ...
    public static EditProfFragment newInstance(String param1, String param2) {
        EditProfFragment fragment = new EditProfFragment();
