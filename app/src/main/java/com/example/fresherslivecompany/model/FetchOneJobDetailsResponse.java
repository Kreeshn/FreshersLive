...
public class FetchOneJobDetailsResponse {
    private int job_id;
    ...
    public FetchOneJobDetailsResponse(int job_id, String profile, String parttime, String work_type, int opening, Date start_date, String duration, String respo, String sallaty_type, String skill_required, String ass1, String ass2, String co_name, String co_desc, String co_email, String co_contact, String co_page, String co_web, int error, String message) {
        this.job_id = job_id;
